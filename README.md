...
Indent is a simple, readable, beginner-friendly programming language (v1.0.0). It uses indentation-based blocks, lowercase keywords, and minimal punctuation — designed to be easy to learn while powerful enough for real work.
...
```bash
./air registry github xytrolabs/indent main packages/index.txt
```
